    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AllContacts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StaffProfilePicture = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    RegionalInfo = table.Column<string>(type: "text", nullable: false),
                    FirstImpression = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()"),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentHeading = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ContentSubHeading = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    BodyContentFileType = table.Column<string>(type: "text", nullable: true),
                    BodyFilePath = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    BuddyDetails = table.Column<string>(type: "text", nullable: false),
                    BuddyActivities = table.Column<string>(type: "text", nullable: false),
                    ChecklistSummary = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    CeoName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    CeoTitle = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    CeoImageUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    CeoMessage = table.Column<string>(type: "text", nullable: false),
                    HrName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    HrTitle = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    HrImageUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    HrMessage = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()"),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", null, new DateTime(2025, 11, 13, 10, 33, 3, 206, DateTimeKind.Utc).AddTicks(2269), "Local hire role", "LOCAL_HIRE", "LOCAL_HIRE" },
                    { "2", null, new DateTime(2025, 11, 13, 10, 33, 3, 206, DateTimeKind.Utc).AddTicks(2280), "Expat role", "EXPAT", "EXPAT" },
                    { "3", null, new DateTime(2025, 11, 13, 10, 33, 3, 206, DateTimeKind.Utc).AddTicks(2288), "Visitor role", "VISITOR", "VISITOR" },
                    { "4", null, new DateTime(2025, 11, 13, 10, 33, 3, 206, DateTimeKind.Utc).AddTicks(2297), "HR Admin role", "HR_ADMIN", "HR_ADMIN" }
                });
